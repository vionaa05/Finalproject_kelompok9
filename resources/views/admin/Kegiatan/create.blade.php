...
@section('content')
    <h3 class="h3 mb-4 text-primary"><i class="fas fa-calendar-plus"></i> Buat Kegiatan Baru</h3>
    
    <div class="card shadow mb-4">
        <div class="card-header py-3" style="background-color: var(--pikma-blue);">
            <h6 class="m-0 font-weight-bold text-white">Form Kegiatan Baru</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.kegiatan.store') }}" method="POST">
                ...
                <button type="submit" class="btn btn-success"><i class="fas fa-save"></i> Simpan Kegiatan</button>
